...
public class SimplexMethodParser {
	...
	public void writeToFile() {
		try{
			FileOutputStream writer = new FileOutputStream("/home/dimka/RevisedSimplexMethod/jni/file.txt");
			writer.write((new String()).getBytes());
			writer.close();
			FileWriter fstream = new FileWriter("/home/dimka/RevisedSimplexMethod/jni/file.txt");
